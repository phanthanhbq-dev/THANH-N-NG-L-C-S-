...
<div class="main-header">
    ...
    <p>Tác giả: PHAN THỊ THANH TRường Tiểu học Vĩnh Hảo - Số ĐT 0948270971
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - PHAN THỊ THANH TRường Tiểu học Vĩnh Hảo - Số ĐT 0948270971</div>", unsafe_allow_html=True)
